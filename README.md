...
这是一个可直接发布到云端的静态报告中心。站点入口为 `index.html`，当前包含“仓颉语言分析”“众包内存分析”“复盘报告”“自动发布报告”和“安全审计报告”五类报告。
...
- `reports/security-audit/`：仓颉编译器/工具链/组件的源码级安全审计报告分类页（当前收录 cjc 前端 2026-06-17 审计）。
